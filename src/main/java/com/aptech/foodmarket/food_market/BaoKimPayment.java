...
public class BaoKimPayment {
	...
	// Mã merchante site
	private String merchant_id = "30558";	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	
	// Mật khẩu bảo mật
	private String secure_pass = "ac55f7e0c02d927c";	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
